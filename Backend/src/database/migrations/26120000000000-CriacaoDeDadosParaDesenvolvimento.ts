...
implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    `,
      [
        TURMA_201, '3A - 2025', 35, '2025', 'Tarde', 1, null, T_SEED, T_SEED,
        TURMA_202, '2B - 2025', 35, '2025', 'Manhã', 1, null, T_SEED, T_SEED,
        TURMA_203, '1C - 2025', 35, '2025', 'Tarde', 1, null, T_SEED, T_SEED,
      ],
    );

    // === 3) professores (usuarios + professores) ===
    const HASH_PROF = '$2b$10$seedteacherplaceholder';
    ...
    const HASH_ALUNO = '$2b$10$seedstudentplaceholder';
    ...
    const alunosUsuarios = [
      ...
      { id: UAL_104, nome: 'Lucas Oliveira', email: 'lucas.o@aluno.test', cpf11: '47525534144', tel: '41990000104', cep8: '80010000', cidade: 'Curitiba', estado: 'PR', logradouro: 'Rua XV de Novembro', numero: '800', compl: null, bairro: 'Centro', nasc: new Date('2011-01-28T00:00:00.000Z') },
      { id: UAL_105, nome: 'Felipe Costa', email: 'felipe.c@aluno.test', cpf11: '92832764851', tel: '51990000105', cep8: '90010000', cidade: 'Porto Alegre', estado: 'RS', logradouro: 'Av. Borges de Medeiros', numero: '900', compl: 'Apto 91', bairro: 'Centro Histórico', nasc: new Date('2011-05-14T00:00:00.000Z') },
      { id: UAL_106, nome: 'Bruno Ribeiro', email: 'bruno.r@aluno.test', cpf11: '35030564160', tel: '92990000106', cep8: '69010000', cidade: 'Manaus', estado: 'AM', logradouro: 'Rua dos Barés', numero: '690', compl: null, bairro: 'Centro', nasc: new Date('2011-09-30T00:00:00.000Z') },
      { id: UAL_107, nome: 'Gabriel Rocha', email: 'gabriel.r@aluno.test', cpf11: '12345678909', tel: '85990000107', cep8: '66010000', cidade: 'Belém', estado: 'PA', logradouro: 'Av. Almirante Barroso', numero: '660', compl: null, bairro: 'Campina', nasc: new Date('2010-12-12T00:00:00.000Z') },
      { id: UAL_108, nome: 'Lucas Almeida', email: 'lucas.a@aluno.test', cpf11: '11144477735', tel: '11990000108', cep8: '01001000', cidade: 'São Paulo', estado: 'SP', logradouro: 'Praça da Sé', numero: '1', compl: null, bairro: 'Sé', nasc: new Date('2010-02-08T00:00:00.000Z') },
      { id: UAL_109, nome: 'Rafael Martins', email: 'rafael.m@aluno.test', cpf11: '52998224725', tel: '21990000109', cep8: '20010000', cidade: 'Rio de Janeiro', estado: 'RJ', logradouro: 'Rua da Assembleia', numero: '20', compl: null, bairro: 'Centro', nasc: new Date('2010-06-25T00:00:00.000Z') },
    ...
    const alunos = [
      ...
      { alunoId: ALUNO_104, usuarioId: UAL_104, turmaId: TURMA_202, matricula: '2025-2B-0001', nome: 'Lucas Oliveira', natural: 'Curitiba/PR', rg: 'RG1040004', rgUf: 'SSP/PR', escola: 'Escola Estadual do Paraná', respCpf: respCpfs[3] },
      { alunoId: ALUNO_105, usuarioId: UAL_105, turmaId: TURMA_202, matricula: '2025-2B-0002', nome: 'Felipe Costa', natural: 'Porto Alegre/RS', rg: 'RG1050005', rgUf: 'SSP/RS', escola: 'Escola Municipal de Porto Alegre', respCpf: respCpfs[4] },
      { alunoId: ALUNO_106, usuarioId: UAL_106, turmaId: TURMA_202, matricula: '2025-2B-0003', nome: 'Bruno Ribeiro', natural: 'Manaus/AM', rg: 'RG1060006', rgUf: 'SSP/AM', escola: 'Escola Estadual do Amazonas', respCpf: respCpfs[5] },
      ...
      { alunoId: ALUNO_108, usuarioId: UAL_108, turmaId: TURMA_203, matricula: '2025-1C-0002', nome: 'Lucas Almeida', natural: 'São Paulo/SP', rg: 'RG1080008', rgUf: 'SSP/SP', escola: 'Escola Estadual de SP', respCpf: respCpfs[7] },
      { alunoId: ALUNO_109, usuarioId: UAL_109, turmaId: TURMA_203, matricula: '2025-1C-0003', nome: 'Rafael Martins', natural: 'Rio de Janeiro/RJ', rg: 'RG1090009', rgUf: 'SSP/RJ', escola: 'Escola Municipal do RJ', respCpf: respCpfs[8] },
    ...
    const atividades = [
      { id: ATIV_601, titulo: 'Simulado MAT - Turma 3A', desc: 'Tipo: simulado', bimestre: '1º Bimestre', dataEntrega: new Date('2025-03-15T09:00:00.000Z'), valor: 10.0, prof: PROF_501, disc: DISC_301, turma: TURMA_201 },
      { id: ATIV_602, titulo: 'Simulado POR - Turma 2B', desc: 'Tipo: simulado', bimestre: '1º Bimestre', dataEntrega: new Date('2025-03-16T09:00:00.000Z'), valor: 10.0, prof: PROF_502, disc: DISC_302, turma: TURMA_202 },
      { id: ATIV_603, titulo: 'Simulado CIE - Turma 1C', desc: 'Tipo: simulado', bimestre: '1º Bimestre', dataEntrega: new Date('2025-03-17T09:00:00.000Z'), valor: 10.0, prof: PROF_503, disc: DISC_304, turma: TURMA_203 },
      { id: ATIV_604, titulo: 'Prova HIS - Turma 3A', desc: 'Tipo: prova', bimestre: '2º Bimestre', dataEntrega: new Date('2025-04-01T10:00:00.000Z'), valor: 8.0, prof: PROF_502, disc: DISC_303, turma: TURMA_201 },
      { id: ATIV_605, titulo: 'Trabalho ING - Turma 2B', desc: 'Tipo: trabalho', bimestre: '2º Bimestre', dataEntrega: new Date('2025-04-05T10:00:00.000Z'), valor: 7.5, prof: PROF_504, disc: DISC_305, turma: TURMA_202 },
      { id: ATIV_606, titulo: 'Tarefa MAT - Turma 1C', desc: 'Tipo: tarefa', bimestre: '2º Bimestre', dataEntrega: new Date('2025-04-10T23:59:00.000Z'), valor: 2.0, prof: PROF_501, disc: DISC_301, turma: TURMA_203 },
    ];
    ...
    await queryRunner.query(
      ...
      [
        AVISO_701,
        'Reunião de pais',
        'Reunião geral de pais e responsáveis em 2025-03-01 às 19:00.',
        'GERAL',
        'ACADEMICO',
        new Date('2025-03-01T19:00:00.000Z'),
        null,
        ADMIN_ID,
        null,
        null,
        ...
        AVISO_702,
        'Aviso Turma 3A',
        'Prova de Matemática adiada para 2025-04-01.',
        'TURMA',
        'ACADEMICO',
        new Date('2025-02-20T12:00:00.000Z'),
        null,
        PROF_501,
        TURMA_201,
        null,
        ...
        AVISO_703,
        'Aviso ao Professor',
        'Atualize os planos de aula até 2025-03-20.',
        'INDIVIDUAL',
        'SECRETARIA',
        ...
        'INDIVIDUAL',
        'SECRETARIA',
        new Date('2025-03-12T10:00:00.000Z'),
        null,
        ADMIN_ID,
        null,
        ALUNO_101,
